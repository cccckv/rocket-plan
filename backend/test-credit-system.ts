...
async function testCreditSystem() {
  ...
  try {
    ...
    const balanceRes = await axios.get(`${BASE_URL}/api/credits/balance`, {
    ...
    const costsRes = await axios.get(`${BASE_URL}/api/credits/costs`, {
      headers: { Authorization: `Bearer ${testToken}` },
    });
    ...
    const historyRes = await axios.get(`${BASE_URL}/api/credits/transactions?limit=5`, {
      headers: { Authorization: `Bearer ${testToken}` },
    });
    ...
    try {
      ...
      const newBalanceRes = await axios.get(`${BASE_URL}/api/credits/balance`, {
        headers: { Authorization: `Bearer ${testToken}` },
      });
      ...
      const newHistoryRes = await axios.get(`${BASE_URL}/api/credits/transactions?limit=5`, {
        headers: { Authorization: `Bearer ${testToken}` },
      });
